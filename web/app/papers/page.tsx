    ...
    <div className="container mx-auto px-4 py-10 max-w-5xl">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground max-w-2xl leading-relaxed">
          Curated finance papers on factors, anomalies, market microstructure, and the replication
          crisis — drawn from the top finance and accounting journals, AI-in-finance venues (ICAIF),
          arXiv q-fin, and the citation graph around canonical work. Listed most-cited first, so the
          field-defining papers lead. Papers with a wiki have structured summaries covering
          construction rules, IS/OOS evidence, and practical implications.
        </p>
      </div>
      ...
      <div className="mt-8 text-xs text-muted-foreground border-t pt-4 space-y-1">
        <p>
          Papers drawn from finance/accounting journals, ICAIF, arXiv q-fin, and citation-graph
          expansion, then filtered for finance relevance and ranked by citation count. Wikis
          generated by Claude Haiku from abstracts and available full text. Not peer-reviewed
          summaries — verify claims against the original paper.
        </p>
        <p>
          Content repo:{' '}
